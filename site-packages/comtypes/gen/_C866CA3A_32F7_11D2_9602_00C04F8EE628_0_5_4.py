...
__all__ = [
    'SFTInput', 'SVSFNLPSpeakPunc', 'SpeechEngineConfidence',
    'STSF_CommonAppData', 'SREInterference', 'SPCS_DISABLED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecoContext',
    'STCInprocServer', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SDKEnumValues', 'SpeechTokenKeyFiles', 'ISpVoice',
    'DISPID_SVAudioOutput', 'SPRULESTATE', 'SpPhraseInfoBuilder',
    'SVP_1', 'SPFM_CREATE_ALWAYS', 'SDA_Consume_Leading_Spaces',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_RESERVED6',
    'DISPIDSPTSI_SelectionOffset', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpXMLRecoResult', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SOTCSetId', 'SPVISEMES', 'DISPID_SPIEnginePrivateData',
    'ISpeechPhraseProperties', 'DISPID_SPANumberOfElementsInResult',
    'SAFTGSM610_22kHzMono', 'SVP_8', 'SITooSlow', 'SVF_Emphasis',
    'SPGRAMMARWORDTYPE', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SOTGetStorageFileName', 'SAFTADPCM_11kHzMono',
    'SPPS_SuppressWord', 'DISPID_SPEAudioTimeOffset',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SVSpeak', 'DISPID_SPCIdToPhone',
    'SAFT16kHz8BitStereo', 'SpWaveFormatEx', 'DISPID_SPAs_NewEnum',
    'ISpStream', 'SPAO_NONE', 'DISPID_SRCResume',
    'DISPID_SGRSAddRuleTransition', 'IEnumString', 'SGRSTTDictation',
    'ISpeechPhraseRules', 'eLEXTYPE_USER_SHORTCUT', 'IStream',
    'SVEAllEvents', 'DISPID_SDKDeleteValue', '__MIDL_IWinTypes_0009',
    'DISPID_SRCState', 'DISPID_SRGIsPronounceable',
    'DISPID_SRGDictationSetState', 'SAFTExtendedAudioFormat',
    'SAFT8kHz8BitMono', 'ISpObjectTokenCategory',
    'DISPID_SRGDictationLoad', 'SPRECOGNIZERSTATUS',
    'SAFT24kHz8BitMono', 'DISPID_SLPsItem', 'SAFT48kHz8BitStereo',
    'SPDKL_CurrentConfig', 'SSFMCreate', 'SVEBookmark',
    'DISPID_SPRuleFirstElement', 'SpeechVoiceSpeakFlags',
    'ISpeechXMLRecoResult', 'SPVPRI_OVER', 'SPSFunction',
    'SPRECOSTATE', 'ISpeechGrammarRules', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechGrammarRule',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpeechAudioBufferInfo', 'SpeechTokenContext', 'SPBINARYGRAMMAR',
    'DISPID_SRRGetXMLResult', 'DISPID_SRGRecoContext',
    'SAFTADPCM_44kHzStereo', 'DISPID_SpeechPhraseAlternate',
    'SpeechRecoProfileProperties', 'SP_VISEME_3',
    'DISPID_SGRsFindRule', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCVoicePurgeEvent', 'SPEVENT',
    'DISPID_SpeechPhraseElement', 'SVP_21', 'SpeechDataKeyLocation',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVEPhoneme', 'SRCS_Disabled',
    'SRTExtendableParse', 'SPRECORESULTTIMES', 'SVEVoiceChange',
    'DISPID_SLWsItem', 'DISPID_SGRName',
    'DISPID_SRRDiscardResultInfo', 'SP_VISEME_7', 'SP_VISEME_12',
    'eLEXTYPE_PRIVATE8', 'SVP_5', 'SLODynamic',
    'DISPID_SWFESamplesPerSec', 'DISPID_SOTsCount', 'SPEI_SOUND_END',
    'SAFT11kHz8BitMono', 'SpeechVoiceSkipTypeSentence',
    'eWORDTYPE_DELETED', 'DISPID_SRCCmdMaxAlternates',
    'SWPUnknownWordPronounceable', 'SPSNoun', 'SPAS_RUN',
    'DISPID_SRProfile', 'eLEXTYPE_PRIVATE3', 'SPVPRI_NORMAL',
    'SpeechVoiceCategoryTTSRate', 'SAFT22kHz16BitMono',
    'DISPID_SWFEFormatTag', 'SpMMAudioOut', 'SPFM_CREATE',
    'DISPID_SRGRules', 'DISPID_SPIStartTime',
    'DISPID_SpeechLexiconWord', 'SRTReSent',
    'DISPID_SVGetAudioInputs', 'eWORDTYPE_ADDED',
    'SPTEXTSELECTIONINFO', 'DISPID_SOTRemove', 'SPEI_TTS_BOOKMARK',
    'SPVPRIORITY', 'SAFT16kHz16BitStereo', 'SDTRule',
    'SAFT12kHz8BitStereo', 'DISPID_SASNonBlockingIO',
    'SpeechVisemeFeature', 'SPAUDIOSTATUS', 'DISPID_SRCEInterference',
    'DISPID_SRIsUISupported', 'SPBO_TIME_UNITS', 'WAVEFORMATEX',
    'SRSEDone', 'ISpRecognizer', 'DISPID_SRCEAdaptation',
    'DISPID_SVAudioOutputStream', 'ISpeechPhraseInfo',
    'SPPS_RESERVED4', 'DISPID_SRCERecognition',
    'SSSPTRelativeToStart', 'SPDKL_LocalMachine', 'ISpeechPhraseRule',
    'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE7', 'DISPID_SADefaultFormat',
    'SP_VISEME_9', 'DISPID_SpeechRecognizerStatus', 'DISPID_SRRAudio',
    'SVSFVoiceMask', 'DISPID_SVSInputSentenceLength',
    'SAFT32kHz8BitMono', 'DISPID_SOTCId',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPIReplacements', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechAllElements', 'eLEXTYPE_PRIVATE5', 'SRAInterpreter',
    'ISpeechVoiceStatus', 'DISPID_SLGenerationId',
    'DISPID_SOTCDefault', 'DISPID_SVEEnginePrivate',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechObjectTokenCategory',
    'SSTTTextBuffer', 'SVP_18', 'DISPID_SABufferInfo',
    'SPSHT_Unknown', 'SPCT_DICTATION', 'SpeechPropertyResponseSpeed',
    'SAFT16kHz16BitMono', 'SRERequestUI', 'SAFT22kHz8BitStereo',
    'DISPID_SVIsUISupported', 'SP_VISEME_15', 'SPVPRI_ALERT',
    'DISPID_SpeechCustomStream', 'SpeechCategoryVoices',
    'SP_VISEME_18', 'eLEXTYPE_PRIVATE2',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_10', 'SPSNotOverriden',
    'SPSMF_UPS', 'SPAUDIOSTATE', 'DISPID_SOTIsUISupported',
    'SVPNormal', 'DISPIDSPRG', 'SVEAudioLevel',
    'DISPID_SPRDisplayAttributes', 'SGSEnabled', 'SITooLoud',
    'DISPID_SRGetFormat', 'SPXRO_Alternates_SML',
    'DISPID_SVSCurrentStreamNumber', 'SP_VISEME_11',
    'ISpeechRecoResult2', 'SP_VISEME_8', 'DISPID_SVStatus',
    'DISPID_SLWs_NewEnum', 'DISPID_SDKEnumKeys',
    'DISPID_SLGetPronunciations', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechRecoContext', 'DISPID_SVSInputWordLength',
    'DISPID_SPACommit', 'SPEI_MAX_SR', 'SPPS_Noncontent',
    '_ISpeechVoiceEvents', 'DISPID_SLWType', 'DISPID_SLPsCount',
    'DISPID_SRRAlternates', 'SPSModifier', 'DISPID_SWFEBitsPerSample',
    'DISPID_SDKDeleteKey', 'SVEStartInputStream',
    'ISpeechPhraseElement', 'SVSFUnusedFlags', 'SAFTADPCM_44kHzMono',
    'DISPID_SVPause', 'SGPronounciation', 'DISPID_SPPId',
    'SWTDeleted', 'eLEXTYPE_PRIVATE19', 'SRADynamic',
    'SECFIgnoreKanaType', 'DISPID_SVSpeakCompleteEvent',
    'SPLOADOPTIONS', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT44kHz8BitStereo', 'DISPID_SVEVoiceChange', 'DISPID_SRState',
    'DISPID_SPEsCount', 'SDA_Two_Trailing_Spaces', 'SpAudioFormat',
    'SRAImport', 'DISPID_SGRSTText', 'ISpGrammarBuilder',
    'ISpRecoContext2', 'LONG_PTR', 'DISPID_SPEActualConfidence',
    'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPWAVEFORMATTYPE',
    'DISPID_SOTGetAttribute', 'ISpeechPhraseElements',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechUserTraining',
    'SPRS_INACTIVE', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechGrammarRules', 'SpeechEngineProperties',
    'SPEI_SOUND_START', 'SREPrivate', 'SpeechRecoContextState',
    'DISPID_SGRClear', 'SAFT48kHz8BitMono', 'ISpeechAudioStatus',
    'SINoSignal', 'SAFTText', 'DISPID_SpeechMemoryStream',
    'SRATopLevel', 'ISpAudio', 'DISPID_SPRuleParent',
    'DISPID_SPPsItem', 'DISPID_SPRuleId', 'SVP_7',
    'DISPID_SVSVisemeId', 'SPPHRASEELEMENT', 'SRERecoOtherContext',
    'DISPID_SVSRunningState', 'DISPID_SRSAudioStatus',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechGrammarTagDictation',
    'SpeechStreamSeekPositionType', 'SPINTERFERENCE_NOISE',
    'SpeechGrammarWordType', 'ISpeechFileStream',
    'SAFT48kHz16BitStereo', 'DISPID_SVEViseme',
    'SpeechPropertyNormalConfidenceThreshold', 'SPSERIALIZEDPHRASE',
    'eLEXTYPE_USER', 'SPINTERFERENCE_TOOFAST', 'SpMMAudioIn',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPAPhraseInfo',
    'SPPHRASE', 'SREAdaptation', 'DISPID_SPIAudioStreamPosition',
    'SPSHT_EMAIL', 'SpeechCategoryRecognizers',
    'ISpeechPhraseAlternate', 'SVSFParseSsml',
    'DISPID_SVGetAudioOutputs', 'eLEXTYPE_APP', 'SDTPronunciation',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTCCITT_ALaw_22kHzStereo',
    'SVSFPurgeBeforeSpeak', 'DISPID_SpeechAudio', 'DISPID_SBSSeek',
    'DISPID_SDKCreateKey', 'SPINTERFERENCE_TOOSLOW', 'SASRun',
    'SVSFIsXML', 'SAFT32kHz8BitStereo', 'SGDisplay', 'SPEI_MIN_SR',
    'SRSInactiveWithPurge', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SLPSymbolic',
    'ISpeechObjectTokenCategory', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SBSWrite',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPEPronunciation',
    'DISPID_SLWsCount', 'SPWORDTYPE', 'SPSSuppressWord',
    'DISPID_SPRsItem', 'ISpeechPhoneConverter',
    'DISPID_SWFEExtraData', 'SVF_None', 'SpeechDiscardType', 'SPSLMA',
    'SAFT44kHz8BitMono', 'DISPID_SGRsCount', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechWaveFormatEx', 'SPEI_WORD_BOUNDARY',
    'DISPID_SOTCreateInstance', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPEI_MAX_TTS', 'DISPID_SpeechLexiconProns', 'DISPID_SDKOpenKey',
    'DISPID_SVSPhonemeId', 'SPAR_High', 'SPEI_PHRASE_START',
    'DISPID_SPERetainedSizeBytes', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechLexiconType', 'SPCT_SUB_DICTATION',
    'SpeechSpecialTransitionType', 'DISPID_SVResume',
    'DISPID_SPEEngineConfidence', 'eLEXTYPE_MORPHOLOGY',
    'SPINTERFERENCE', 'DISPID_SRCreateRecoContext',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSAddWordTransition',
    'DISPID_SFSClose', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRRAudioFormat', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechRecognizer', 'SLOStatic', 'Speech_StreamPos_Asap',
    'ISpeechRecoResultTimes', 'DISPID_SOTDataKey',
    'eLEXTYPE_PRIVATE12', 'SRTAutopause', 'SGSDisabled',
    'SREPropertyStringChange', 'SPXRO_SML', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPAsItem', 'DISPID_SDKSetBinaryValue',
    'SAFTNoAssignedFormat', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SASState', 'DISPID_SPEAudioStreamOffset', 'SITooQuiet',
    'SpStreamFormatConverter', 'SPEI_HYPOTHESIS',
    'DISPID_SRCEEndStream', 'DISPID_SRRTOffsetFromStart',
    'SGRSTTEpsilon', 'SVSFIsFilename', 'SGDSActiveUserDelimited',
    'SPEI_RESERVED3', 'SP_VISEME_14', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPIAudioSizeBytes', 'SECFEmulateResult', 'SpCustomStream',
    'SRSEIsSpeaking', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVGetProfiles', 'SECFNoSpecialChars', 'SpMMAudioEnum',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRCERequestUI', 'SpeechVisemeType',
    'SRESoundStart', 'SpeechRuleState', 'SVP_20', 'DISPID_SRIsShared',
    'DISPID_SPRulesCount', 'SpeechBookmarkOptions',
    'DISPID_SLRemovePronunciation', 'SPSHT_NotOverriden',
    'DISPID_SLGetGenerationChange', 'DISPID_SLAddPronunciation',
    'SDTDisplayText', 'DISPID_SMSGetData', 'SP_VISEME_19',
    'DISPID_SLWWord', 'SAFT12kHz16BitStereo', 'SVP_12', 'SVP_16',
    'SPXMLRESULTOPTIONS', 'DISPID_SPCLangId', 'SAFT24kHz8BitStereo',
    'SPPS_Unknown', 'SSFMOpenForRead', 'SPFM_NUM_MODES',
    'SP_VISEME_17', 'ISpeechRecognizerStatus', 'ISpeechVoice',
    'SPAS_CLOSED', 'ISpRecognizer3', 'SVSFNLPMask',
    'SAFT12kHz16BitMono', 'SREHypothesis', 'DISPID_SGRs_NewEnum',
    'DISPID_SGRSRule', 'ISpStreamFormatConverter', 'SDKLCurrentUser',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPSHT_OTHER', 'SDTAll',
    'DISPID_SpeechPhraseProperties',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SDKGetlongValue',
    'SAFTDefault', 'SPEVENTENUM', 'SAFTGSM610_8kHzMono',
    'SPRST_ACTIVE', 'ISpeechRecoGrammar', 'SSTTWildcard',
    'DISPID_SOTCGetDataKey', 'SAFT32kHz16BitMono', 'SRAORetainAudio',
    'eLEXTYPE_RESERVED7', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SGRSTNextState', 'DISPID_SVEventInterests',
    'DISPID_SCSBaseStream', 'DISPID_SPPFirstElement', 'SPWORDLIST',
    'DISPID_SPIProperties', 'SPPHRASEPROPERTY', 'SPAUDIOOPTIONS',
    'SPFILEMODE', 'SpeechVoicePriority', 'SRTEmulated',
    'SAFT11kHz16BitMono', 'SPAR_Low', 'DISPIDSPTSI_ActiveOffset',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRSClsidEngine',
    'DISPID_SVSLastResult', 'DISPID_SOTCategory', 'SPWF_INPUT',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCEPropertyNumberChange', 'SGLexicalNoSpecialChars',
    'DISPID_SRCERecognitionForOtherContext', 'SPWT_PRONUNCIATION',
    'DISPIDSPTSI_ActiveLength', 'SGRSTTTextBuffer', 'SVP_10',
    'DISPID_SRGCmdLoadFromResource', 'SAFTNonStandardFormat',
    'ISpProperties', 'DISPID_SBSRead', 'SPPS_NotOverriden',
    'SSSPTRelativeToCurrentPosition', 'SpStream', 'SAFT16kHz8BitMono',
    'DISPID_SVSpeakStream', 'SpeechAudioFormatGUIDText',
    '_ISpeechRecoContextEvents', 'SVP_19', 'DISPID_SPRulesItem',
    'SAFT11kHz8BitStereo', 'SPPROPERTYINFO', 'SPCT_SUB_COMMAND',
    'SpeechEmulationCompareFlags', 'SVEPrivate',
    'SpeechCategoryRecoProfiles', 'STCLocalServer',
    'Speech_Default_Weight', 'SDA_One_Trailing_Space',
    'SPEI_START_SR_STREAM', 'DISPID_SPIGetDisplayAttributes',
    'SPLO_STATIC', 'SAFT44kHz16BitStereo', 'ISpeechWaveFormatEx',
    'DISPID_SRGState', 'SP_VISEME_16', 'SVP_6',
    'SpeechPropertyResourceUsage',
    'ISpeechGrammarRuleStateTransition', 'ISpeechRecoResultDispatch',
    'DISPID_SDKGetStringValue', 'ISpRecoResult',
    'DISPID_SRSNumberOfActiveRules', 'SPRST_ACTIVE_ALWAYS',
    'SPPS_Modifier', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechObjectTokens', 'SPEI_RECOGNITION',
    'SpObjectTokenCategory', 'DISPID_SpeechAudioStatus',
    'DISPID_SDKSetStringValue', 'SpeechGrammarState', 'SGDSInactive',
    'ISpDataKey', 'SpeechCategoryAppLexicons', 'DISPID_SOTId',
    'ISpeechPhraseReplacement', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRSaveToMemory', 'SWTAdded', 'SAFTADPCM_22kHzMono',
    'SPSERIALIZEDRESULT', 'SREBookmark', 'SSSPTRelativeToEnd',
    'DISPID_SPIElements', 'SDTProperty', 'SRCS_Enabled', 'SVPOver',
    'IEnumSpObjectTokens', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SMSALineId', 'DISPID_SPPsCount',
    'DISPID_SpeechMMSysAudio', 'SPRS_ACTIVE', 'SPSEMANTICERRORINFO',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPELexicalForm',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPCPhoneToId',
    'SPEVENTSOURCEINFO', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechRecoResultTimes', 'SpeechRecognizerState',
    'SRADefaultToActive', 'tagSTATSTG', 'DISPID_SGRSTType',
    'DISPID_SGRId', 'DISPID_SPIRetainedSizeBytes',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SABIBufferSize',
    'SVSFParseAutodetect', 'SpSharedRecoContext',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SpeechFileStream',
    'DISPID_SPEsItem', 'eLEXTYPE_PRIVATE9', 'SP_VISEME_2',
    'SVSFParseSapi', 'SFTSREngine', 'SRAONone', 'SPEI_VOICE_CHANGE',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SOTMatchesAttributes',
    'SPPS_LMA', 'SPEI_PHONEME', 'DISPID_SAEventHandle', 'SGRSTTWord',
    'DISPID_SVPriority', 'DISPID_SGRSTPropertyId',
    'SAFT22kHz16BitStereo', 'eLEXTYPE_PRIVATE15', 'SDTReplacement',
    'DISPID_SPRText', 'DISPID_SPRFirstElement',
    'DISPID_SpeechRecoResult', 'DISPID_SVSInputSentencePosition',
    'DISPID_SPIGrammarId', 'SPWT_DISPLAY', 'DISPID_SVEAudioLevel',
    'SpeechAudioState', 'SRESoundEnd', 'SWPKnownWordPronounceable',
    'SPRST_NUM_STATES', 'SPEI_SR_BOOKMARK', 'DISPID_SPRuleConfidence',
    'DISPID_SLPLangId', 'SP_VISEME_13', 'DISPID_SRCEStartStream',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechVoiceStatus',
    'SDTAudio', 'SAFT8kHz16BitStereo', 'DISPID_SRStatus',
    'SPEI_RESERVED1', 'SpInprocRecognizer', 'SpeechRuleAttributes',
    'DISPID_SASetState', 'SSFMOpenReadWrite', 'DISPID_SPARecoResult',
    'SpeechCategoryAudioIn', 'ISpSerializeState',
    'SAFTCCITT_uLaw_22kHzMono', 'SpTextSelectionInformation',
    'DISPID_SRGDictationUnload', 'SpPhoneticAlphabetConverter',
    'SWPUnknownWordUnpronounceable', 'SpeechVoiceEvents',
    'SVEPhoneme', 'SPCT_COMMAND', 'SPSUnknown',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCVoice',
    'SpeechAudioProperties', 'SpUnCompressedLexicon',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechLexiconWords',
    'DISPID_SRCBookmark', 'ISpeechPhraseReplacements',
    'SPSHORTCUTPAIR', 'SpeechTokenKeyUI', 'ISpMMSysAudio',
    'SITooFast', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseReplacements', 'SDA_No_Trailing_Space',
    'SPRST_INACTIVE', 'SVEViseme', 'eLEXTYPE_LETTERTOSOUND',
    'SPCS_ENABLED', 'SREPhraseStart', 'DISPID_SVESentenceBoundary',
    'SGDSActiveWithAutoPause', 'SBOPause', 'SSFMCreateForWrite',
    ...
    'SRERecognition', 'STSF_AppData', 'ISpeechGrammarRuleState',
    'SpeechWordType', 'DISPID_SRCRecognizer', 'DISPID_SGRSTRule',
    'SDTLexicalForm', 'ISpPhoneticAlphabetSelection', 'SPBO_PAUSE',
    'DISPID_SPIGetText', 'SPEI_TTS_PRIVATE', 'DISPID_SGRAddResource',
    'DISPID_SREmulateRecognition', 'SPEI_END_INPUT_STREAM',
    'SPFM_OPEN_READONLY', 'DISPID_SPERequiredConfidence',
    'DISPID_SGRSTPropertyValue', 'SREAllEvents',
    'DISPID_SRCEBookmark', 'SPAR_Unknown', 'DISPID_SGRSTPropertyName',
    'DISPID_SRCEPhraseStart', 'DISPID_SBSFormat', 'ISpeechDataKey',
    'SP_VISEME_6', 'SPWORDPRONUNCIATIONLIST', 'SAFT24kHz16BitStereo',
    'DISPID_SOTs_NewEnum', 'SAFT12kHz8BitMono', 'SpInProcRecoContext',
    'ISpLexicon', 'eLEXTYPE_PRIVATE14', 'DISPID_SPIEngineId',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SLTApp', 'SPAS_STOP',
    'SpMemoryStream', 'DISPID_SpeechObjectToken',
    'DISPID_SRAudioInput', 'SPAS_PAUSE', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPPConfidence', 'DISPID_SPPValue', 'SpeechAddRemoveWord',
    'DISPID_SRCEventInterests', 'DISPID_SLPType',
    'DISPID_SDKGetBinaryValue', 'SPEI_RECO_STATE_CHANGE', 'SPSVerb',
    'SpeechTokenKeyAttributes', 'SpCompressedLexicon',
    ...
    'SVEEndInputStream', 'SPEI_REQUEST_UI',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SABIMinNotification', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_RESERVED10', 'DISPID_SOTsItem', 'SVP_3',
    'DISPID_SRRTLength', 'STCInprocHandler', 'DISPID_SVEWord',
    'ISpPhrase', 'ISpeechGrammarRuleStateTransitions',
    'SPAUDIOBUFFERINFO', 'SPEI_RECO_OTHER_CONTEXT',
    'SDKLDefaultLocation', 'SPPS_Function', 'DISPID_SMSSetData',
    'SPEI_ADAPTATION', 'SVPAlert', 'SPDKL_DefaultLocation',
    'DISPID_SOTGetDescription', 'DISPID_SGRSTWeight',
    'DISPID_SMSAMMHandle', 'SECFIgnoreWidth',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SGRsDynamic', 'STCAll',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpVoice',
    'SPINTERFERENCE_TOOQUIET', 'SpObjectToken', 'SPPS_Verb',
    'SSTTDictation', 'ISpeechRecoResult', 'SASClosed',
    ...
    'DISPID_SPRNumberOfElements', 'SVSFIsNotXML', 'ISpeechMMSysAudio',
    'ISpeechPhraseProperty', 'SAFT8kHz8BitStereo',
    'SpeechStreamFileMode', 'SAFTADPCM_22kHzStereo',
    'SPDATAKEYLOCATION', 'STSF_FlagCreate', 'SVEWordBoundary',
    'SRSActiveAlways', 'SVP_4', 'DISPID_SVSInputWordPosition',
    'DISPID_SVDisplayUI', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPPEngineConfidence', 'SPGRAMMARSTATE', 'SREAudioLevel',
    'SpeechRegistryUserRoot', 'SREStreamStart', 'eLEXTYPE_PRIVATE6',
    'SPINTERFERENCE_NONE', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPRuleName', 'SpeechGrammarTagWildcard',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRSActive',
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_VENDORLEXICON',
    'SP_VISEME_21', 'SASStop', 'SpSharedRecognizer',
    'DISPID_SpeechPhraseInfo', 'DISPID_SLWPronunciations',
    'SPPS_RESERVED1', 'SVP_11', 'SpFileStream',
    'DISPID_SPEAudioSizeBytes', 'SpeechDictationTopicSpelling',
    'ISpEventSink', 'SECHighConfidence',
    'ISpeechLexiconPronunciation', 'DISPID_SPPNumberOfElements',
    'eLEXTYPE_RESERVED8', 'SAFTGSM610_44kHzMono',
    'SpeechCategoryAudioOut', 'DISPID_SRRTimes', 'DISPID_SpeechVoice',
    'SECFIgnoreCase', 'SPSInterjection',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SWFEBlockAlign', 'SVP_9',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechDataKey',
    'ISpeechGrammarRule', 'SPGS_ENABLED', 'DISPID_SPPParent',
    'ISpeechAudioFormat', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPLO_DYNAMIC', 'DISPID_SGRsCommit', 'DISPID_SVVoice',
    'ISpeechCustomStream', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechPhraseAlternates', 'SPWT_LEXICAL',
    'Speech_Max_Word_Length', 'SPPS_Noun', 'SVSFParseMask',
    'SAFTGSM610_11kHzMono', 'SpNullPhoneConverter',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'SVSFlagsAsync', 'DISPID_SVVolume', 'ISpeechBaseStream',
    'ISpeechResourceLoader', 'DISPID_SVRate', 'DISPID_SLPPhoneIds',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGId', 'ISpeechRecognizer',
    'SpeechDisplayAttributes', 'eLEXTYPE_RESERVED9', 'SGDSActive',
    'SPPHRASERULE', 'SPPARTOFSPEECH', 'ISpNotifyTranslator',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_4',
    'UINT_PTR', 'SPBO_AHEAD', 'SPSTREAMFORMATTYPE', 'SRTSMLTimeout',
    'SPLEXICONTYPE', 'SpeechAudioFormatType',
    'DISPID_SVSLastBookmark', 'DISPID_SRSSupportedLanguages',
    'DISPID_SLPs_NewEnum', 'DISPID_SVWaitUntilDone',
    'ISpeechLexiconWord', 'SPEI_RESERVED5', 'ISpEventSource',
    'DISPID_SRCPause', 'DISPID_SPRs_NewEnum',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SGRsItem', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechAudioFormat', 'DISPID_SASCurrentSeekPosition',
    'SPEI_END_SR_STREAM', 'SpeechInterference', 'SAFT22kHz8BitMono',
    'SPSEMANTICFORMAT', 'DISPID_SRRTTickCount', 'ISpObjectToken',
    'DISPID_SRCEAudioLevel', 'DISPID_SRGetPropertyString',
    'SpeechFormatType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPPName',
    'ISpeechRecoContext', 'DISPID_SRRSpeakAudio', 'SPEI_SR_PRIVATE',
    'SP_VISEME_1', 'DISPID_SRSetPropertyNumber', 'SpeechPartOfSpeech',
    'SAFT24kHz16BitMono', 'DISPID_SRGetPropertyNumber',
    'SPEI_UNDEFINED', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SAStatus', 'SpeechTokenShellFolder',
    'SpeechTokenValueCLSID', 'DISPID_SVAlertBoundary',
    'eLEXTYPE_PRIVATE1', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRSetPropertyString', 'SP_VISEME_0',
    'DISPID_SPIAudioSizeTime', 'SpPhoneConverter',
    'SpResourceManager', 'SVP_0', 'DISPID_SWFEChannels',
    'DISPID_SAFType', 'ISpRecoGrammar2', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRDisplayUI', 'ISpeechTextSelectionInformation',
    'DISPID_SRCEHypothesis', 'DISPID_SABIEventBias', 'SGSExclusive',
    'ISpNotifySource', 'ISpRecognizer2', 'DISPID_SVEStreamStart',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRCRetainedAudio', 'SPGS_EXCLUSIVE',
    'ISpStreamFormat', '_RemotableHandle', 'DISPID_SAVolume',
    'SPEI_RESERVED2', 'DISPID_SPILanguageId', 'SPVOICESTATUS',
    'SVP_13', 'DISPID_SMSADeviceId', 'SAFT48kHz16BitMono',
    'DISPID_SpeechPhraseElements', 'SVP_17', 'DISPID_SFSOpen',
    'SPWF_SRENGINE', 'DISPID_SGRSAddSpecialTransition',
    'IInternetSecurityMgrSite', 'SRTStandard', 'SRAExport',
    'SpeechRunState', 'SVP_14', 'SPPS_Interjection',
    'SAFT32kHz16BitStereo', 'tagSPPROPERTYINFO', 'ISpeechAudio',
    'SVSFPersistXML', 'SpeechRecoEvents', 'SPSMF_SAPI_PROPERTIES',
    'SPCATEGORYTYPE', 'SVSFDefault', 'SPEI_SENTENCE_BOUNDARY',
    'ISpRecoCategory', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SGRAddState',
    'ISpRecoGrammar', 'SREStreamEnd', 'SpShortcut',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRSTsCount', 'SPBO_NONE',
    'SPWORDPRONUNCIATION', 'SDKLCurrentConfig', 'ISequentialStream',
    'STCRemoteServer', 'DISPID_SVSkip', 'SpeechRetainedAudioOptions',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPIRule',
    'DISPID_SRCSetAdaptationData', 'ISpPhoneConverter',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpShortcut',
    'SPWORDPRONOUNCEABLE', 'SRSInactive',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRCEFalseRecognition',
    'SPEI_INTERFERENCE', 'SPEI_PROPERTY_NUM_CHANGE',
    'SECLowConfidence', 'SINoise', 'SRARoot', 'SREPropertyNumChange',
    'ISpeechLexicon', 'SAFTADPCM_11kHzStereo', 'SVP_15',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SpeechLexicon', 'SVP_2',
    'DISPID_SRRecognizer', 'SINone', '_SPAUDIOSTATE',
    'DISPID_SPISaveToMemory', 'ISpeechLexiconWords',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPEI_VISEME',
    'DISPID_SpeechPhraseRules', 'DISPID_SRGCmdLoadFromFile',
    'SPDKL_CurrentUser', 'SPCONTEXTSTATE', 'SPPS_RESERVED2',
    'SDTAlternates', 'DISPID_SpeechPhraseProperty',
    'eLEXTYPE_RESERVED4', 'SpeechAudioVolume', 'SDKLLocalMachine',
    'DISPID_SPEDisplayAttributes', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpNotifySink', 'SP_VISEME_5', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVEStreamEnd', 'SGLexical', 'SGRSTTRule', 'SpLexicon',
    'SECFDefault', 'DISPID_SRGetRecognizers',
    'DISPID_SRCRequestedUIType', 'DISPID_SAFGuid',
    'DISPID_SRRTStreamTime', 'DISPID_SRGReset', 'SPGS_DISABLED',
    'SECNormalConfidence', 'SpNotifyTranslator', 'SLTUser',
    'SPEI_RESERVED6', 'DISPID_SPAsCount', 'SVF_Stressed',
    'ISpeechMemoryStream', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpPhraseAlt', 'DISPID_SPEDisplayText', 'DISPID_SGRInitialState',
    'SpeechMicTraining', 'SREStateChange', 'ISpeechObjectToken',
    'SVESentenceBoundary', 'SPSHORTCUTTYPE', 'SAFT8kHz16BitMono',
    'ISpResourceManager', 'SpeechRecognitionType',
    'DISPID_SpeechAudioBufferInfo',
    'SpeechGrammarTagUnlimitedDictation', 'STSF_LocalAppData',
    'SAFT44kHz16BitMono', 'SPSHORTCUTPAIRLIST', 'DISPIDSPTSI',
    'SPFM_OPEN_READWRITE', 'SPPS_RESERVED3',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechBaseStream',
    'SPAO_RETAIN_AUDIO', 'DISPID_SLWLangId', 'DISPID_SPPs_NewEnum',
    'SPRULE', 'ISpeechObjectTokens', 'SASPause',
    'DISPID_SRCCreateGrammar', 'DISPID_SOTSetId', 'DISPID_SRGCommit',
    'ISpObjectWithToken', 'DISPID_SGRSTsItem', 'SPAR_Medium',
    'DISPID_SPPChildren', 'eLEXTYPE_PRIVATE17', 'SREFalseRecognition',
    'SpeechRegistryLocalMachineRoot', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechRecoResult2', 'DISPID_SGRsCommitAndSave',
    'SPCT_SLEEP', 'DISPID_SGRAttributes', 'DISPID_SPRuleChildren',
    'IInternetSecurityManager', 'DISPID_SRAudioInputStream',
    'SPEI_START_INPUT_STREAM', 'SP_VISEME_20', 'SBONone',
    'DISPID_SGRSTransitions', 'DISPID_SRRRecoContext',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SGRsAdd',
    'DISPID_SpeechPhoneConverter', 'SpeechLoadOption',
    'DISPID_SpeechVoiceEvent', 'SPWORD', 'DISPID_SRGSetTextSelection',
    'SpeechWordPronounceable', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SLGetWords',
    'DISPID_SRGCmdSetRuleState', 'SPEI_SR_RETAINEDAUDIO'
]

_check_version('1.2.0', 1698798667.324679)
