...
__all__ = [
    'Gray', 'OLE_XPOS_PIXELS', 'OLE_YPOS_PIXELS', 'StdPicture',
    'Picture', 'Color', 'IPictureDisp', 'IFontEventsDisp',
    'OLE_HANDLE', 'OLE_XSIZE_PIXELS', 'StdFont', 'Monochrome',
    'LoadPictureConstants', 'Default', 'FONTBOLD',
    'OLE_XPOS_CONTAINER', 'OLE_TRISTATE', 'OLE_YPOS_CONTAINER',
    'OLE_CANCELBOOL', 'IFont', 'OLE_ENABLEDEFAULTBOOL',
    'FONTSTRIKETHROUGH', 'Unchecked', 'OLE_COLOR', 'FONTNAME',
    'FONTUNDERSCORE', 'OLE_XPOS_HIMETRIC', 'FONTSIZE', 'FontEvents',
    'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_HIMETRIC', 'IFontDisp',
    'Checked', 'FONTITALIC', 'OLE_YSIZE_PIXELS', 'OLE_OPTEXCLUSIVE',
    'OLE_YPOS_HIMETRIC', 'VgaColor', 'IPicture', 'Font',
